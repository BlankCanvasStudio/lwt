...
export expr_name_base="chat-gpt-basic-questions" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/chat-gpt/basic-questions/prompt.py"
