...
export expr_name_base="discord-basic-chat" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/discord/basic-chat/chat1.py"
export tap_rcv_exe="./scenarios/websites/discord/basic-chat/chat2.py"
# Set these options if you want to use iperf3 over a custom program
