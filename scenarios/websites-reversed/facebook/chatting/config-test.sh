...
export expr_name_base="facebook-chat" # Sim number gets added automatically
...
export repititions=20 # How many trials to run
...
export tap_rcv_build="./init/loc/selenium.sh"
export tap_gen_exe="./scenarios/websites/facebook/chatting/chat1.py"
export tap_rcv_exe="./scenarios/websites/facebook/chatting/chat2.py"
...
export tap_user_resolve_via_tapsrvr=true
