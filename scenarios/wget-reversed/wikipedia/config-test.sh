...
export expr_name_base="wget-wikipedia-reversed" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/wget/wikipedia/download.sh"
...
export tap_gen_destructor="./scenarios/wget/wikipedia/client-destructor.sh"
