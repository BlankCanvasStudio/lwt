...
export expr_name_base="wget-squid-websites" # Sim number gets added automatically
...
export tap_rcv_build="./init/loc/squid.sh"
export tap_gen_exe="./scenarios/wget-squid-websites/use-proxy.sh"
