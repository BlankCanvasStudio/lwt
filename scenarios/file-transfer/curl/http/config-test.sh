...
export expr_name_base="curl-http-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/curl/http/copy.sh"
export tap_rcv_exe="./scenarios/file-transfer/curl/http/server.py"
# Set these options if you want to use iperf3 over a custom program
