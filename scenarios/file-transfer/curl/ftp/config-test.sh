...
export expr_name_base="curl-ftp-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/curl/ftp/copy.sh"
...
export tap_gen_destructor="./scenarios/file-transfer/curl/ftp/client-destructor.sh"
