...
export expr_name_base="rsync-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/rsync/copy.sh"
...
export tap_gen_destructor="./scenarios/file-transfer/rsync/client-destructor.sh"
