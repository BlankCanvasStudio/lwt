...
export expr_name_base="scp-rand-data" # Sim number gets added automatically
...
export tap_gen_destructor="./scenarios/file-transfer/scp/client-destructor.sh"
...
export tap_gen_exe="./scenarios/file-transfer/scp/copy.sh"
