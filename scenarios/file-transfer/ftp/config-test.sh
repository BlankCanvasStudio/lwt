...
export expr_name_base="true-ftp-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/ftp/copy.sh"
...
export tap_gen_destructor="./scenarios/file-transfer/ftp/client-destructor.sh"
