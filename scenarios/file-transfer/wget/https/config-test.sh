...
export expr_name_base="wget-https-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/wget/https/copy.sh"
export tap_rcv_exe="./scenarios/file-transfer/wget/https/build-server.sh"
# Set these options if you want to use iperf3 over a custom program
...
export tap_gen_destructor="./scenarios/file-transfer/wget/https/client-destructor.sh"
export tap_rcv_destructor="./scenarios/file-transfer/wget/https/srvr_destructor.sh"
