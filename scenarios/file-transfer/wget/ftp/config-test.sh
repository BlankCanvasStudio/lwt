...
export expr_name_base="wget-ftp-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/wget/ftp/copy.sh"
export tap_rcv_exe="./scenarios/file-transfer/ftp/server.py"
# Set these options if you want to use iperf3 over a custom program
