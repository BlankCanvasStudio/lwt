...
export expr_name_base="wget-http-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/wget/http/copy.sh"
export tap_rcv_exe="./scenarios/file-transfer/wget/http/server.py"
# Set these options if you want to use iperf3 over a custom program
...
export tap_gen_destructor="./scenarios/file-transfer/wget/http/client-destructor.sh"
