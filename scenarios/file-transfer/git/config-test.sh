...
export expr_name_base="git-linux-from-github" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/file-transfer/git/copy.sh"
...
export tap_gen_destructor="./scenarios/file-transfer/git/client-destructor.sh"
