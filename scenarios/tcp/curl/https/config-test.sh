...
export expr_name_base="tcp-curl-https-rand-data" # Sim number gets added automatically
...
export tap_rcv_build="./init/loc/nginx.sh"
export tap_gen_exe="./scenarios/file-transfer/curl/https/copy.sh"
export tap_rcv_exe="./scenarios/file-transfer/curl/https/build-server.sh"
# Set these options if you want to use iperf3 over a custom program
...
export tap_gen_destructor="./scenarios/file-transfer/curl/http/client-destructor.sh"
