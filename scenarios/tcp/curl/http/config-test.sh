...
export expr_name_base="tcp-curl-http-rand-data" # Sim number gets added automatically
...
export tap_rcv_build="./init/loc/rand-file.sh"
export tap_gen_exe="./scenarios/tcp/curl/http/copy.sh"
export tap_rcv_exe="./scenarios/tcp/curl/http/server.py"
# Set these options if you want to use iperf3 over a custom program
...
export tap_gen_destructor="./scenarios/tcp/curl/http/client-destructor.sh"
