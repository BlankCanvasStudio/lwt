...
export expr_name_base="tcp-curl-ftp-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/tcp/curl/ftp/copy.sh"
...
export tap_gen_destructor="./scenarios/tcp/curl/ftp/client-destructor.sh"
