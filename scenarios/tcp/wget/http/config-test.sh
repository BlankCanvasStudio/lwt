...
export expr_name_base="tcp-wget-http-rand-data" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/tcp/wget/http/copy.sh"
export tap_rcv_exe="./scenarios/tcp/wget/http/server.py"
# Set these options if you want to use iperf3 over a custom program
...
export tap_gen_destructor="./scenarios/tcp/wget/http/client-destructor.sh"
