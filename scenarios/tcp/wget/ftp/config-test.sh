...
export expr_name_base="tcp-wget-ftp-rand-data" # Sim number gets added automatically
...
export tap_rcv_build="./init/loc/ftp-server.sh"
export tap_gen_exe="./scenarios/tcp/wget/ftp/copy.sh"
export tap_rcv_exe="./scenarios/tcp/ftp/server.py"
# Set these options if you want to use iperf3 over a custom program
