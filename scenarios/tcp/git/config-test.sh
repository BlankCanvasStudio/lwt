...
export expr_name_base="tcp-git-linux-from-github" # Sim number gets added automatically
...
# Files the hosts execute. Need to be able to run these with the syntax ./filename
export tap_gen_build="./init/loc/git.sh"
export tap_rcv_build="./init/loc/rand-file.sh"
export tap_gen_exe="./scenarios/tcp/git/copy.sh"
...
export tap_gen_destructor="./scenarios/tcp/git/client-destructor.sh"
