...
export expr_name_base="tcp-ping-2s-350B" # Sim number gets added automatically
...
export pipe_iperf3_udp=false # Use UDP or TCP data
...
export tap_gen_destructor="./scenarios/ping-2s-15B/destructor.sh"
