...
export expr_name_base="tcp-gtranslate-basic-lorem-reversed" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/gtranslate/basic-lorem/translate.py"
