...
export expr_name_base="tcp-twitch-view-home-reversed" # Sim number gets added automatically
...
# NOTE ON BANDWIDTH: If its exactly the same as your link, data loss increases. Having higher than is much more consistent
...
export tap_gen_exe="./scenarios/websites/twitch/view-home/view.py"
