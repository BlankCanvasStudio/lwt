...
export expr_name_base="tcp-twitch-basic-streamer-view-reversed" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/twitch/basic-streamer-view/view.py"
