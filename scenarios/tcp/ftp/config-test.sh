...
export expr_name_base="tcp-true-ftp-rand-data" # Sim number gets added automatically
...
# Files the hosts execute. Need to be able to run these with the syntax ./filename
export tap_gen_build="./init/loc/ftp-client.sh"
export tap_rcv_build="./init/loc/ftp-server.sh"
export tap_gen_exe="./scenarios/tcp/ftp/copy.sh"
...
export tap_gen_destructor="./scenarios/tcp/ftp/client-destructor.sh"
