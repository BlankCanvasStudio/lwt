...
export expr_name_base="tcp-rsync-rand-data" # Sim number gets added automatically
...
# Files the hosts execute. Need to be able to run these with the syntax ./filename
export tap_gen_build="./init/loc/rsync.sh"
export tap_rcv_build="./init/loc/rand-file.sh"
export tap_gen_exe="./scenarios/tcp/rsync/copy.sh"
export tap_rcv_exe="./init/loc/rsync.sh"
...
export tap_gen_destructor="./scenarios/tcp/rsync/client-destructor.sh"
