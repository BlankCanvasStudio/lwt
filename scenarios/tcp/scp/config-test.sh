...
export expr_name_base="tcp-scp-rand-data" # Sim number gets added automatically
...
export tap_gen_destructor="./scenarios/tcp/scp/client-destructor.sh"
...
export tap_gen_exe="./scenarios/tcp/scp/copy.sh"
