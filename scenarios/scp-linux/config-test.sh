...
export expr_name_base="scp-linux" # Sim number gets added automatically
...
# Files the hosts execute. Need to be able to run these with the syntax ./filename
export tap_gen_build="./scenarios/scp-linux/build-scp-client.sh"
export tap_rcv_build="./scenarios/scp-linux/build-scp-server.sh"
export tap_gen_exe="./scenarios/scp-linux/get-data.sh"
...
export tap_gen_destructor="./scenarios/scp-linux/client-destructor.sh"
