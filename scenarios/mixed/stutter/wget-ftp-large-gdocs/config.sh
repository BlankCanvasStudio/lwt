...
export expr_name_base="mixed-stutter-wget-ftp-large-gdocs"
...
config_files=(
    'scenarios/file-transfer/wget/ftp/config-test.sh'
    'scenarios/websites-reversed/gdocs/basic-writing/config-test.sh'
)
