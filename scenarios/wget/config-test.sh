...
export expr_name_base="wget-multiple" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/wget/download.sh"
...
export tap_gen_destructor="./scenarios/wget/client-destructor.sh"
