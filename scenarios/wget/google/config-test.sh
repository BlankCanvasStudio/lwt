...
export expr_name_base="wget-google" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/wget/google/download.sh"
...
export tap_gen_destructor="./scenarios/wget/google/client-destructor.sh"
