...
export expr_name_base="f-ping-400B-3s-h-iperf-80M" # Sim number gets added automatically
...
export pipe_gen_exe="./scenarios/gen/f-ping-400B-3s-h-iperf-100M/ping.sh"
export pipe_rcv_exe="./nfra/empty.sh"
...
export pipe_iperf3_bps=80M # Bandwidth you want 
...
export tap_gen_exe="./scenarios/ping-2s-350B/ping.sh"
...
# NOTE ON BANDWIDTH: If its exactly the same as your link, 
#   data loss increases. Having higher than is much more consistent
export tap_iperf3_bps=80M # Bandwidth you want
