...
export expr_name_base="f-iperf-40M-h-iperf-40M"
...
# NOTE ON BANDWIDTH: If its exactly the same as your link, 
#   data loss increases. Having higher than is much more consistent
export tap_iperf3_bps=40M # Bandwidth you want
...
export user_tap_runs_tcpdump=true
export tap_user_interface="ens1f3" # What interface you'd like to dump
export user_tap_data_file="srvr_tap.pcap"
