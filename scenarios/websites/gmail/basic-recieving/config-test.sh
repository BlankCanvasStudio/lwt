...
export expr_name_base="gmail-basic-recieving" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/gmail/basic-recieving/recv-gmail.py"
export tap_rcv_exe="./scenarios/websites/gmail/basic-recieving/send-gmail.py"
# Set these options if you want to use iperf3 over a custom program
