...
try:
    dm = firefox.find_element(By.CSS_SELECTOR, '[aria-label="lwtchatone (direct message)"]')
except:
    dm = firefox.find_element(By.CSS_SELECTOR, '[aria-label="unread, lwtchatone (direct message)"]')

dm.click()


msg_box = firefox.find_element(By.CSS_SELECTOR, '[aria-label="Message @lwtchatone"')
msg_box.click()
...
while True:
    # Alternate when they send chats so they "respond" to eachother
