...
export expr_name_base="gdocs-listen-to-writing-same" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/gdocs/same-acc-listen-to-writing/listen.py"
export tap_rcv_exe="./scenarios/websites/gdocs/same-acc-listen-to-writing/write.py"
# Set these options if you want to use iperf3 over a custom program
