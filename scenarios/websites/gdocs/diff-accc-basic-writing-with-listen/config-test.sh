...
export expr_name_base="gdocs-listen-&-writing-diff" # Sim number gets added automatically
...
export tap_gen_exe="./scenarios/websites/gdocs/diff-acc-basic-writing-with-listen/tapped.py"
export tap_rcv_exe="./scenarios/websites/gdocs/diff-acc-basic-writing-with-listen/other.py"
# Set these options if you want to use iperf3 over a custom program
