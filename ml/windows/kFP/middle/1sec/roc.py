...
print(y_test.shape) # 91
print(y_score.shape) # 92
...
plt.title('Receiver Operating Characteristic for kFP with a 1 second window taken at a random slice')
