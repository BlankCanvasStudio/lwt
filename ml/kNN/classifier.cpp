...
//Data parameters
int FEAT_NUM = 628; //number of features
int ROUND_NUM = 3000000;
int NEIGHBOUR_NUM = 4; //number of neighbors for kNN
int RECOPOINTS_NUM = 4; //number of neighbors for distance learning
...
void accuracy(float** trainfeat, float** testfeat, int* trainfeatclasses, int* testfeatclasses, string* trainfeatnames, string* testfeatnames, int trainlen, int testlen, float* weight) {
    ...
    FILE * flog;
    string fname;
    fname = d["OUTPUT_LOC"] + "Wa-kNN-" + d["CORE_NAME"] + "-flearner.score";
