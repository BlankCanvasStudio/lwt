...
def RF_openworld(testnames, ofname, max_class):
    ...
    return M, testlabel, model, testdata


def GenerateResults(guesses, answers, forest, x_test):
...
def main():
    ...
    try:
        ...
        M, testlabel, forest, x_test = RF_openworld(testnames, ofname, d["CLOSED_SITENUM"]) #testnames is only used to output score here
