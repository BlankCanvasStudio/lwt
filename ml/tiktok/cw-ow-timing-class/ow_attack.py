...
# This just seems to be an ML classifier to see if the example is monitored or not
    # This might actually be the most effective way to do things I suppose
def main():
    """
    """
    # Parse arguments
    ...
    y_mon = to_categorical(y_mon, unmon_label+1)
    ...
    y_unmon_tr = to_categorical(y_unmon[args.world_size:], unmon_label+1)
