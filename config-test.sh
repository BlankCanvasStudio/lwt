...
export expr_name_base="testbed-diag"
# data_dir="../data-lwt" # so you don't need to keep the data in the same repo
# export data_dir="/mnt/stor0/searchlight/lwt" # so you don't need to keep the data in the same repo
export data_dir="../data-lwt"

export repititions=1 # How many trials to run
...
export pipe_iperf3_bps=40M # Bandwidth you want 
...
# export pipe_rcv_interface="eth1"
...
# Files the hosts execute. Need to be able to run these with the syntax ./filename
export tap_gen_build="./nfra/generation/empty.sh"
export tap_rcv_build="./nfra/generation/empty.sh"
export tap_gen_exe="./nfra/generation/ping.sh"
...
# NOTE ON BANDWIDTH: If its exactly the same as your link, 
#   data loss increases. Having higher than is much more consistent
export tap_iperf3_bps=40K # Bandwidth you want
export tap_iperf3_length=1448B
export tap_iperf3_pacing=0.000 # smaller values should make traffic smoother (in ms)
...
# Settings for tapuser. Above names are bad but legacy
...
export tap_gen_destructor="./nfra/generation/empty.sh"
export tap_rcv_destructor="./scenarios/file-transfer/curl/https/srvr_destructor.sh"
...
# export click_collector_core_mask="FFFFFFFFFFFF"
export click_collector_core_mask="FFFFFFFFFFF" # Got 0.006ms
# export click_collector_core_mask="FFFFFFFFFF" # This appears to be better?
# export click_collector_core_mask="FFFFFFFFF"  # This one is definitely way worse
export click_collector_net_lanes="16"

# export router_file="./nfra/collection/minimal/writer/router.cpp"
# export click_collector_object_c_files="./nfra/collection/click-timestamper/mem-opt/*"

# Seems to be best for 100Mbps
# export router_file="./nfra/collection/erik-comp/dump/router.cpp"
# export click_collector_object_c_files="./nfra/collection/erik-comp/dump/*"
...
# export router_file="./nfra/collection/erik/router.cpp"
# export click_collector_object_c_files="./nfra/collection/erik/DataCollector/*"
...
export limiting_router_driver="vfio-pci"
...
export tap_user_resolve_via_tapuser=false
